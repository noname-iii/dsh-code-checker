...
export function reportMessage(text) {
...
export function deliverToAgent(agent, text, mode, isClean = false) {
...
export function truncateReport(text, maxChars) {
    // 文本长度未超上限时原样返回
...
export function fixInstruction(language) {
    // 中文指令
    if (language === 'zh') {
