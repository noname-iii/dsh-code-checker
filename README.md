...
> **Latest release: v0.5.0** — GitHub Releases, with an offline tarball asset `dsh-code-checker-0.5.0.tgz`:
...
1. Download `dsh-code-checker-0.5.0.tgz` from <https://github.com/noname-iii/dsh-code-checker/releases/latest>.
